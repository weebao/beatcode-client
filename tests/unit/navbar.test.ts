...
test("navbar should render correctly (unauthorized)", () => {
...
test("navbar should render correctly (authorized)", () => {
...
test("dropdown should show when profile menu is clicked" , async () => {
    const results = render(Navbar, { user });
