...
{#if $page.url.pathname !== "/game"}
    <nav class="flex h-nav w-full flex-col items-center justify-center self-stretch overflow-hidden px-8 max-md:max-w-full">
        <div class="flex min-h-[80px] w-full max-w-[1280px] flex-wrap items-center justify-between gap-10">
