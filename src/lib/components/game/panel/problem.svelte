...
<div class="h-full overflow-y-auto bg-background px-4 py-5">
    ...
    <div
        class="prose prose-invert !h-[2px] !max-w-full first:mt-0 prose-p:my-2 prose-code:font-normal prose-code:text-foreground/80 prose-code:before:content-none prose-code:after:content-none prose-pre:my-0 prose-pre:bg-neutral prose-pre:text-base prose-ul:mt-0 marker:text-foreground"
    >
