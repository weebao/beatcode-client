...
export const RoomSettingsSchema = z.object({
    ...
    hp_multiplier_easy: z
        .number()
        .min(1)
        .default(DefaultRoomSettings.hp_multiplier_easy),
    hp_multiplier_medium: z
        .number()
        .min(1)
        .default(DefaultRoomSettings.hp_multiplier_medium),
    hp_multiplier_hard: z
        .number()
        .int()
        .min(1)
        .default(DefaultRoomSettings.hp_multiplier_hard),
